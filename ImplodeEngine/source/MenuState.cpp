...
MenuState::MenuState(GameContext* context) : GameState(context)
{
	...
	this->m_textLog = new TextLog("Log", sf::Vector2f(20.0f, 300), sf::Vector2f(1.5f, 3.0f), this->m_assetPool->GetTexture("DropDown"), this->m_assetPool->GetFont("font"), sf::Color::Black, 15, true, 15,sf::Vector2f(30.0f,30.0f),10);
